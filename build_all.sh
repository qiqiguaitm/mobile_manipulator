...
# 分层包定义 - 数据结构即算法
readonly L0_THIRDPARTY="realsense2_camera realsense2_description rf2o_laser_odometry rslidar_sdk"
readonly L1_DESCRIPTION="mobile_manipulator2_description piper_description tracer2_description"
readonly L2_DRIVERS="arm_controller chassis_controller camera_driver lidar_driver imu_driver"  
...
main() {
    ...
    case "${1:-all}" in
        ...
        "l0"|"thirdparty") build_layer "L0-第三方库" "$L0_THIRDPARTY" ;;
