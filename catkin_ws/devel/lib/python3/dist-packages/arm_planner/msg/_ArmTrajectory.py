...
"""autogenerated by genpy from arm_planner/ArmTrajectory.msg. Do not edit."""
import codecs
import sys
...
class ArmTrajectory(genpy.Message):
  _md5sum = "68689ced2efc48fd92ee34a688a837e9"
  _type = "arm_planner/ArmTrajectory"
...
float64 w
"""
  __slots__ = ['header','joint_names','points','end_pose']
  _slot_types = ['std_msgs/Header','string[]','trajectory_msgs/JointTrajectoryPoint[]','geometry_msgs/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,joint_names,points,end_pose
    ...
    """
    if args or kwds:
      super(ArmTrajectory, self).__init__(*args, **kwds)
